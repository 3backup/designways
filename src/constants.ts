...
export const MAGIC_TOKEN = "pk_live_6A8CF7F906BC895E";
export const DEFAULT_PAGE_PATH = "/events";
export const GA_TRACKING_ID = "G-6GN8QJ3EFR";

export const productDiscoverySpeakers = [
  {
    name: "Michał Reda",
    image: Michal,
    firstParagraph:
      "Doświadczony Product and Growth Manager. Trener i ewangelizator obszaru Product Discovery w Polsce. Ma na koncie kilkanaście wypuszczonych produktów. W przeszłości pełnił takie role jak Head of R&D, Head of Growth czy Dyrektora marketingu i rozwoju produktów w różnorodnych organizacjach. ",
    secondParagraph:
      "„Moją pasją jest odkrywanie, budowanie oraz skalowanie rozwiązań, które pozostają w sercach użytkowników i robią robotę dla biznesu. Od 3 lat pomagam innym i dzielę się wiedzą z zakresu Product Managementu ze szczególnym uwzględnieniem Product Discovery, a także budowania kultury eksploracji i eksperymentacji w biznesie. ",
  ...
  },
  {
    ...
    secondParagraph:
      "W każdym z projektów wdrażał i demokratyzował procesy badawcze wewnątrz organizacji, skupiając się na obszarze discovery oraz na szybkiej walidacji odpowiadając za wdrożenie oraz analizę eksperymentów w procesie Growth.",
