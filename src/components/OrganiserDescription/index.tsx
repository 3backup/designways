...
export const OrganiserDescription = () => {
  return (
    <div className="OrganiserDescription">
      ...
      <div className="OrganiserDescription__text">
        Podczas warsztatów:
        <ul className="OrganiserDescription__text--ul">
          <li className="OrganiserDescription__text--li">
          ...
          <li className="OrganiserDescription__text--li">
            ...
            warsztatów stawiamy na różnorodne ćwiczenia warsztatowe, dyskusje
            oraz odnoszenie się do realnych case studies.
          </li>
          <li className="OrganiserDescription__text--li">
