        ...
        <div className="form__inputContainer">
          ...
          <div className="form__singleInputWithLabel--elements">
            <div className="form__singleinputWithLabelContainer">
              ...
              <WorkshopTagButton isHuge name="Darmowe" />
              <WorkshopTagButton isHuge name="Płatne" />
            </div>
            <div className="form__singleinputWithLabelContainer">
        ...
        <div className="form__inputContainer">
          ...
          <div className="form__singleInputWithLabel--elements">
            <div className="form__singleinputWithLabelContainer">
              ...
              <WorkshopTagButton isHuge name="Online" />
              <WorkshopTagButton isHuge name="Stacjonarne" />
            </div>
            <div className="form__singleinputWithLabelContainer">
          ...
          <div className="form__singleInputWithLabel">
            <div className="form__singleInputWithLabel--elements">
              <div className="form__singleinputWithLabelContainer">
                ...
                <WorkshopTagButton isHuge name="Tak" />
                <WorkshopTagButton isHuge name="Nie" />
              </div>
            </div>
          </div>
        </div>
